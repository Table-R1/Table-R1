...
{%- else %}
    {%- set system_message = "A conversation between User and Assistant. The user asks a question, and the assistant solves it. The assistant first thinks about the reasoning process in the mind and then provides the user with the answer. The reasoning process and answer are enclosed within <think> </think> and <answer> </answer> tags, respectively, i.e., <think> reasoning process here </think> <answer> answer here </answer>." %}
{%- endif %}
...
def upload_model_to_huggingface(hf_path):
    ...
    api = HfApi()
    api.create_repo(repo_id=args.hf_upload_path, exist_ok=True)
